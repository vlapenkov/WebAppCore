...
namespace WebAppCore.Services
{
    ...
    public class LocalizationService
    {
        ...
        IRepository<LocaleStringResource> _lsrRepository;
        private int defaultWorkingLanguageId = 1;
        ...
        protected virtual void InsertLocaleStringResources(IList<LocaleStringResource> resources)
        {
            ...
            //insert
            _dbContext.LocaleStringResources.AddRange(resources);
        ...
        public virtual LocaleStringResource GetLocaleStringResourceByName(string resourceName)
        {
          //  if (_workContext.WorkingLanguage != null)
                return GetLocaleStringResourceByName(resourceName, defaultWorkingLanguageId);
        ...
        {
          //  if (_workContext.WorkingLanguage != null)
                return GetResource(resourceKey, defaultWorkingLanguageId);
        ...
        */
            ...
            where TEntity : BaseEntity, ILocalizedEntity
        {
            ...
            if (!languageId.HasValue)
                languageId = defaultWorkingLanguageId;// _workContext.WorkingLanguage.Id;
        ...
        */
        ...
        public virtual string GetLocalizedEnum<TEnum>(TEnum enumValue, int? languageId = null) where TEnum : struct
        {
            ...
            var result = GetResource(resourceName, languageId ?? defaultWorkingLanguageId, false, string.Empty, true);
